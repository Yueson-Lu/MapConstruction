...
public class TouchImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private boolean matrixCheck() {
        ...
        // 缩放比率判断
        if (width < widthScreen / 10 || width > widthScreen * 10) {
            return true;
        }
        // 出界判断
        if ((x1 < widthScreen / 10 && x2 < widthScreen / 10
                && x3 < widthScreen / 10 && x4 < widthScreen / 10)
                || (x1 > widthScreen * 2 / 10 && x2 > widthScreen * 2 / 10
                && x3 > widthScreen * 2 / 10 && x4 > widthScreen * 2 / 10)
                || (y1 < heightScreen / 10 && y2 < heightScreen / 10
                && y3 < heightScreen / 10 && y4 < heightScreen / 10)
                || (y1 > heightScreen * 2 / 10 && y2 > heightScreen * 2 / 10
                && y3 > heightScreen * 2 / 10 && y4 > heightScreen * 2 / 10)) {
            return true;
        }
        return false;
    }
